...
define(function( require, exports, module ){
	...
	exports.url = function(){
		...
		return 'https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=' + pluginConfigParams.appid + '&redirect_uri=' + escape(cacheGlobal.website + '/profile/plugins/' + this.folder + '/callback.asp?f=' + thisURL + '&pid=' + this.id + '&pmark=' + this.mark);
	}
});
%>