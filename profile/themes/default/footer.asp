	<div class="pj-wrapper fn-clear pj-footer">
    	<div class="fn-left">&copy; 2012 <a href="default.asp">lols.com</a>. Valid <a href="http://jigsaw.w3.org/css-validator/check/referer">CSS</a> &amp; <a href="http://validator.w3.org/check?uri=referer">XHTML</a> Timer <%=config.timers()%></div>
