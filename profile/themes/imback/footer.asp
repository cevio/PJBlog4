	<div class="pj-wrapper fn-clear pj-footer">
    	<div class="fn-left">Powered By PJBlog v<%=config.version%> &copy; 2012-2013 <a href="default.asp"><%=pageCustomParams.global.title%></a>. Valid <a href="http://jigsaw.w3.org/css-validator/check/referer">CSS</a> &amp; <a href="http://validator.w3.org/check?uri=referer">XHTML</a>. Run Timer: <%=config.timers()%></div>
