...
define(function(require, exports){
	exports.editCategorySimple = function(){
		return '<form action="' + config.ajaxUrl.server.updateCate + '" method="post"><div class="custom fn-clear">'
			...
			+					'<tr><td class="name">是否为隐藏分类</td><td class="value"><input type="radio" name="cateIsShow" value="1" /> 是 <input type="radio" name="cateIsShow" value="0" checked="checked"  /> 否</td></tr>'
			+					'<tr><td class="name">是否为外部链接</td><td class="value"><input type="radio" name="cateOutLink" value="1" /> 是 <input type="radio" name="cateOutLink" value="0" checked="checked" /> 否</td></tr>'
